...
class MedicoSerializer(serializers.ModelSerializer):
    ...
    def validate_id_usuario(self, value):
        if value.tipo_usuario not in (TipoUsuario.MEDICO, TipoUsuario.ADMIN):
            raise serializers.ValidationError('El usuario debe ser MEDICO o ADMIN para registrar perfil médico.')
        return value
