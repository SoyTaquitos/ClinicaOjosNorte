...
class MedicoViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['activo', 'especialidad_principal']
    search_fields = ['id_usuario__nombres', 'id_usuario__apellidos', 'matricula', 'especialidad_principal', 'subespecialidad']
    ordering_fields = ['id_usuario__apellidos', 'especialidad_principal', 'anios_experiencia', 'fecha_creacion']
