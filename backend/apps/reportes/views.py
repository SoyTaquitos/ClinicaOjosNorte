...
def _build_consultas_por_especialista(start_dt, end_dt, especialista_id=None, search=None, sort_by=None, sort_dir='asc'):
    consultas = ConsultaMedica.objects.select_related('id_especialista__id_usuario').filter(
        fecha_creacion__gte=start_dt,
        fecha_creacion__lt=end_dt,
    )
    if especialista_id:
    ...
    grouped = (
        consultas.values(
            'id_especialista',
            'id_especialista__id_usuario__nombres',
            'id_especialista__id_usuario__apellidos',
    ...
    items = [
        {
            ...
            'especialista': f"{row['id_especialista__id_usuario__apellidos']}, {row['id_especialista__id_usuario__nombres']}",
