...
- Delegate by concern to `backend`, `frontend`, `ui-ux`, `architecture`, `architect-planner`, `code-review`, `qa-testing`, and `devops`.
...
- Route rules:
  ...
  - Mobile app flows, native permissions, mobile build/release -> `mobile`.
